...
db.add_all([
  ...
  User(username='testuser', email='testuser@nover.com', password='testpassword')
])
...
db.add_all([
  ...
  Post(title='Morbi non quam nec dui luctus rutrum', post_url='https://nasa.gov/donec.json', user_id=6),
  ...
  Post(title='Pellentesque eget nunc', post_url='http://google.ca/nam/nulla/integer.aspx', user_id=6)
])
...
db.add_all([
  ...
  Comment(comment_text='Aliquam erat volutpat. In congue.', user_id=4, post_id=1),
  Comment(comment_text='Quisque arcu libero, rutrum ac, lobortis vel, dapibus at, diam.', user_id=2, post_id=3),
  Comment(comment_text='In hac habitasse platea dictumst.', user_id=6, post_id=3)
])
